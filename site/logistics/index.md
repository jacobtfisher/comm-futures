...
<div class="logistics-page">
    ...
    <div class="logistics-quick-grid" aria-label="Conference locations">
        <div class="logistics-quick-card">
            <span class="logistics-card-label">Conference</span>
            <strong>MSU Union</strong>
            <span>49 Abbot Road</span>
        </div>
        <div class="logistics-quick-card">
            <span class="logistics-card-label">Hotel</span>
            <strong>Graduate East Lansing</strong>
            <span>133 Evergreen Avenue</span>
        </div>
        <div class="logistics-quick-card">
            <span class="logistics-card-label">Airport shuttle</span>
            <strong>Michigan Flyer</strong>
            <span>East Lansing stop: 333 Albert Avenue</span>
        </div>
    </div>
    ...
    <section id="getting-here" class="logistics-section">
        ...
        <div class="logistics-card-grid logistics-card-grid--two">
            <article class="logistics-card logistics-card--accent">
                <p class="logistics-card-label">Airport shuttle</p>
                <h3>Michigan Flyer</h3>
                <p>Michigan Flyer operates daily round trips between Detroit Metro Airport, Ann Arbor, and East Lansing. The East Lansing stop is at the Marriott under the skywalk on Albert Street, at <strong>333 Albert Avenue</strong>.</p>
                <dl class="logistics-facts">
                    <div>
                        <dt>Service</dt>
                        <dd>14 daily round trips</dd>
                    </div>
                    <div>
                        <dt>Advance booking</dt>
                        <dd>Reservations open 180 days out</dd>
                    </div>
                    <div>
                        <dt>DTW fare</dt>
                        <dd>$35 one way / $60 round trip online</dd>
                    </div>
                </dl>
                <a class="button" href="https://www.michiganflyer.com/schedule-route" target="_blank" rel="noopener">Check schedules</a>
                <a class="button button--outline" href="https://www.michiganflyer.com/fares" target="_blank" rel="noopener">View fares</a>
            </article>

            <article class="logistics-card">
                <p class="logistics-card-label">Once you arrive</p>
                <h3>Campus + local transit</h3>
                <p>The MSU Union is at <strong>49 Abbot Road</strong>. MSU provides campus maps and visitor information, while CATA operates bus service in East Lansing and offers free on-campus rides.</p>
                <div class="logistics-link-stack">
                    <a href="https://maps.msu.edu/" target="_blank" rel="noopener">MSU maps and directions <span aria-hidden="true">↗</span></a>
                    <a href="https://www.cata.org/" target="_blank" rel="noopener">CATA bus information <span aria-hidden="true">↗</span></a>
                    <a href="https://union.msu.edu/about/contact" target="_blank" rel="noopener">MSU Union information <span aria-hidden="true">↗</span></a>
                </div>
            </article>
        </div>

        <aside class="logistics-note">
            <strong>Travel note:</strong> Michigan Flyer schedules can shift because of traffic, weather, holidays, and special events. Reserve your trip and check the live schedule before traveling to DTW.
        </aside>
    </section>
    ...
    <section id="around-town" class="logistics-section">
        ...
        <div class="logistics-map-layout">
            ...
            <aside class="logistics-map-guide">
                ...
                <ol class="logistics-landmark-list">
                    <li>
                        <span class="landmark-number">01</span>
                        <div><strong>Graduate East Lansing</strong><span>133 Evergreen Avenue</span></div>
                    </li>
                    <li>
                        <span class="landmark-number">02</span>
                        <div><strong>MSU Union</strong><span>49 Abbot Road</span></div>
                    </li>
                    <li>
                        <span class="landmark-number">03</span>
                        <div><strong>Michigan Flyer</strong><span>333 Albert Avenue</span></div>
                    </li>
                    <li>
                        <span class="landmark-number">04</span>
                        <div><strong>Downtown East Lansing</strong><span>Grand River + Albert</span></div>
                    </li>
                </ol>
                <a class="text-link" href="https://www.cityofeastlansing.com/2621/Downtown-East-Lansing" target="_blank" rel="noopener">Browse the city’s business directory <span aria-hidden="true">↗</span></a>
            </aside>
        </div>
        ...
        <div class="logistics-coffee-block">
            ...
            <div class="logistics-coffee-grid">
                ...
                <article class="logistics-coffee-card logistics-coffee-card--anchor">
                    <p class="coffee-location">Inside the MSU Union</p>
                    <h4>Strange Matter Coffee</h4>
                    <p>A first-floor coffee and bakery counter inside the conference building, with additional public seating throughout the Union.</p>
                    <a class="text-link" href="https://strangemattercoffee.com/about/hours/" target="_blank" rel="noopener">Location + hours <span aria-hidden="true">↗</span></a>
                </article>

                <article class="logistics-coffee-card">
                    <p class="coffee-location">196 Albert Avenue</p>
                    <h4>Foster Coffee</h4>
                    <p>A downtown café just off Abbot Road, close to the Michigan Flyer stop and the Albert Avenue pedestrian area.</p>
                    <a class="text-link" href="https://fostercoffee.co/pages/cafe-locations" target="_blank" rel="noopener">Visit Foster <span aria-hidden="true">↗</span></a>
                </article>
                ...
                <article class="logistics-coffee-card">
                    <p class="coffee-location">501 E. Grand River Avenue</p>
                    <h4>Haraz Coffee House</h4>
                    <p>Yemeni coffee and tea, specialty drinks, and pastries a little farther east along Grand River.</p>
                    <a class="text-link" href="https://harazcoffeehouse.com/" target="_blank" rel="noopener">Visit Haraz <span aria-hidden="true">↗</span></a>
                </article>
            </div>
        </div>
        ...
        <div class="logistics-card-grid logistics-card-grid--three logistics-nearby-grid">
            <article class="logistics-card logistics-card--compact">
                ...
                <ul class="logistics-place-list">
                    ...
                    <li><a href="https://www.beggarsbanquet.com/" target="_blank" rel="noopener">Beggar’s Banquet</a><span>218 Abbot Road</span></li>
                    <li><a href="https://www.peanutbarrel.com/" target="_blank" rel="noopener">Peanut Barrel</a><span>521 E. Grand River Ave.</span></li>
                </ul>
            </article>
            ...
            <article class="logistics-card logistics-card--compact">
                ...
                <ul class="logistics-place-list">
                    ...
                    <li><a href="https://www.campbellsmarketbasket.net/" target="_blank" rel="noopener">Campbell’s Market Basket</a><span>545 E. Grand River Ave.</span></li>
                    <li><a href="https://www.msu.edu/visit" target="_blank" rel="noopener">Spartan Spirit Shop</a><span>Inside the MSU Union</span></li>
                </ul>
            </article>
            ...
            <article class="logistics-card logistics-card--compact">
                ...
                <ul class="logistics-place-list">
                    ...
                    <li><a href="https://www.cityofeastlansing.com/2621/Downtown-East-Lansing" target="_blank" rel="noopener">Downtown art + galleries</a><span>Rotating displays and local shops</span></li>
                    <li><a href="https://www.graduaterockbar.com/" target="_blank" rel="noopener">Rock Bar rooftop</a><span>Views of campus · 21+ after 8 p.m.</span></li>
                </ul>
            </article>
        </div>
    </section>
    ...
    <section id="free-time" class="logistics-section">
        ...
        <div class="logistics-activity-grid">
            ...
            <article class="logistics-activity">
                <span class="activity-index">B</span>
                <h3>Visit the Broad</h3>
                <p>The MSU Broad Art Museum is always free and open to everyone, with changing exhibitions and a striking building on campus.</p>
                <a class="text-link" href="https://broadmuseum.msu.edu/visit/" target="_blank" rel="noopener">Plan your visit <span aria-hidden="true">↗</span></a>
            </article>
            <article class="logistics-activity">
            ...
            <article class="logistics-activity">
                ...
                <div class="activity-links">
                    ...
                    <a class="text-link" href="https://www.whartoncenter.com/" target="_blank" rel="noopener">Wharton Center <span aria-hidden="true">↗</span></a>
                </div>
            </article>
        </div>
    </section>
